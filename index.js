...
async function main() {
  ...
  karnos[1] = (
    await axios.get("https://programforyou.ru/js/json/karno_2.json?v=3")
  ).data;
  karnos[2] = (
    await axios.get("https://programforyou.ru/js/json/karno_3.json?v=3")
  ).data;
  karnos[3] = (
    await axios.get("https://programforyou.ru/js/json/karno_4.json?v=3")
  ).data;
  karnos[4] = (
    await axios.get("https://programforyou.ru/js/json/karno_5.json?v=3")
  ).data;
